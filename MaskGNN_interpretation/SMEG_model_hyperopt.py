...
def SMEG_hyperopt(times, task_name, max_evals=30, classification=False):
    ...
    # during training, we build the dataset and dataloader
    # here, we do not specify the smask_path. The smask_path is used for substructure mask
    # this means that we do not use substructure mask in this case!
