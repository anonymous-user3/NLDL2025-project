...
# this function is used during the testing stage! 
# it is used to generate the prediction of the substructure mask
def SMEG_explain_for_substructure(seed, task_name, rgcn_hidden_feats=[64, 64, 64], ffn_hidden_feats=128,
    ...
    # since we specify the smask path, the mask will be loaded (as opposed to during training!)
    ...
    stopper.load_checkpoint(model) # load the best model for this seed (seed means which ensemble member we mean - a bit confusing with the name!)
